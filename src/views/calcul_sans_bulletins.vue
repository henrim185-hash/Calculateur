<template>
    ...
    <div class="container">
        ...
        <section id="salaires" class="section-info">
            <div class="section-container">
                ...
                <p class="section-hint">Indiquer: Dates d'embauche et de rupture, SMCC</p>
        ...
        <section id="indemnite-licenciement">
            <div class="section-container indem-licenciement">
                ...
                <div
                    ...
                    <!-- Calcul par tranche -->
                    <div class="result-item" v-for="(tranche, i) in tranchesLicenciement" :key="i">
                        <div>
        ...
        <section id="preavis">
            <div class="section-container preavis-box">
                ...
                <p class="section-hint">Indiquer le SMMBI et la durée du préavis (en mois)</p>
                ...
                <div
                    ...
                    <div class="result-item">
                        <div>
                            ...
                            <span class="value">
                                {{ smbbiDetail.total.toLocaleString('fr-FR') }} FCFA
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="result-item">
                        <div>
                            Durée du préavis :
                            <span class="value"> {{ dureePreavisMois }} mois </span>
                        </div>
                    </div>
                    ...
                    <h4 style="margin: 20px 0 10px 0">Méthode</h4>
                    <p style="font-size: 0.9rem; color: #555">
                        Indemnité = SMMBI × durée du préavis
                    </p>
                </div>
            </div>
        </section>
        ...
        <section id="gratification">
            <div class="section-container gratification-box">
                ...
                <p class="section-hint">Indiquer: Salaire Minima Conventionnel Catégoriel</p>
        ...
        <section id="dommages-licenciement-abusif">
            <div class="section-container indem-abusif">
                ...
                <div
                    ...
                    <h4 class="legal-title">Base légale</h4>
                    <p class="legal-text">
                        Code du travail – licenciement abusif (dommages-intérêts fixés entre un
                        minimum et un maximum en fonction de l'ancienneté)
                    </p>
        ...
        <section id="dommages-certificat">
            <div class="section-container certificat-box">
                ...
                <p class="section-hint">Indiquer: SMMBI reconstitué et le nombre de mois</p>
        ...
        <section id="dommages-releve">
            <div class="section-container certificat-box">
                ...
                <div
                    ...
                    <h4 class="legal-title">Base légale</h4>
                    <p class="legal-text">
                        Code du travail – obligation de délivrance des documents de fin de contrat
                    </p>
    ...
    <div id="pdf-content" class="pdf-container">
        ...
        <div class="result-box" v-if="smbbiDetail">
            ...
            <div class="result-item">
                Quote-part prime d'ancienneté mensuelle :
                <span class="value">{{ formatMoney(smbbiDetail.primeAnciennete) }}</span>
            </div>

            <div class="result-item">
                Quote-part gratification mensuelle :
                <span class="value">{{ formatMoney(smbbiDetail.gratificationMensuelle) }}</span>
            </div>

            <div class="result-item total">
                <strong>SMMBI RECONSTITUÉ : </strong>
                <span class="value highlight">{{ formatMoney(smbbiDetail.total) }}</span>
            </div>
        </div>
        ...
        <div
            ...
            <div class="result-item">
                <div>
                    SMMBI (base de calcul) :
                    <span class="value">{{ smbbiDetail.total.toLocaleString('fr-FR') }} FCFA</span>
                </div>
            </div>
            ...
            <div class="result-item highlight">
                <div>
                    <strong>TOTAL DOMMAGES : </strong>
                    <span class="value">{{ dommagesInterets.toLocaleString('fr-FR') }} FCFA</span>
                </div>
            </div>
        </div>
...
<script setup>
    ...
    const smbbiDetail = computed(() => {
        ...
        const primeAnciennete =
            includeAnciennete.value === 'oui' ? (base * tauxAnciennete.value) / 100 : 0
        // CORRIGÉ : renommé gratificationMensuelle pour éviter le conflit de nom
        const gratificationMensuelle = includeGratification.value === 'oui' ? (base * 0.75) / 12 : 0
    ...
    // indemnité (variable que TU veux garder)
    ...
    const totalRappel = computed(() => tranchesRappel.value.reduce((acc, t) => acc + t.montant, 0))
    ...
    const montantBrutDI = computed(() => {
        if (!ancienneteDetail.value || ancienneteDetail.value.erreur || !smbbiDetail.value) return 0
    ...
    const dommagesInterets = computed(() => {
        ...
        return Math.round(
            Math.min(Math.max(montantBrutDI.value, plancherLegal.value), plafondLegal.value),
        )
    })
    ...
    const totalDommagesCNPS = computed(() => cotisationMensuelle.value * dureeContratMois.value)
